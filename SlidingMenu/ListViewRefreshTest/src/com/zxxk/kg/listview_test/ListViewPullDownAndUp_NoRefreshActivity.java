...
import com.zxxk.kg.listview_test.listview.MyListViewPullDownAndUp_NoRefresh;
import com.zxxk.kg.listview_test.listview.MyListViewPullDownAndUp_NoRefresh.RefreshListener;
...
public class ListViewPullDownAndUp_NoRefreshActivity extends Activity{

		   private MyListViewPullDownAndUp_NoRefresh lv;
		   ...
		   protected void onCreate(Bundle savedInstanceState) {
		       ...
		       setContentView(R.layout.listviewpulldownandup_norefreshactivity);
		       ...
		       data.add("33333333333111111111111111");
		       data.add("11111111111111111111122222222222222");
		       lv=(MyListViewPullDownAndUp_NoRefresh) findViewById(R.id.lv);
		 ...
		 class MyAdapter extends BaseAdapter{
		   ...
		   TextView tv=new TextView(ListViewPullDownAndUp_NoRefreshActivity.this);
