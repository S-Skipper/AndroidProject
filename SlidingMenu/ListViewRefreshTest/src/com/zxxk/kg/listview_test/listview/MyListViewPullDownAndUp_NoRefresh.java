...
public class MyListViewPullDownAndUp_NoRefresh extends ListView {
	...
	public MyListViewPullDownAndUp_NoRefresh(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public MyListViewPullDownAndUp_NoRefresh(Context context) {
		super(context);
		init(context);
	}
